...
- The simple confirmed-swing retracement model was best on `ETH/USDT 1h`: `avg_r=0.8479`, `win_rate=0.7059`, `fill_rate=0.68`.
- `SOL/USDT 15m` and `BTC/USDT 1h` were also positive, but weaker.
- `SOL/USDT 1h`, `SOL/USDT 4h`, and `ETH/USDT 15m` were negative.
