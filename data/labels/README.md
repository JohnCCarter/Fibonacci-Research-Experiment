...
Labels skrivs via `uv run python -m fibengine.labeling.tool` (begrÃ¤nsningar: [`docs/labeling/LABELING_TOOL.md`](../docs/labeling/LABELING_TOOL.md)).
...
**TvÃ¥ giltiga typer av maskin-svar** (motor-swing vs chartfÃ¶nster): [`docs/labeling/MACHINE_LABELING.md`](../docs/labeling/MACHINE_LABELING.md).
...
- Spara via labeling tool: `p` (push leg), sedan `s` â€” se [LABELING_TOOL.md](../docs/labeling/LABELING_TOOL.md) Â§5B.
...
**Motor anvÃ¤nder inte** `legs[]` Ã¤n â€” endast research/golden. Se [MTF_DAILY_RESEARCH.md](../docs/research/MTF_DAILY_RESEARCH.md).
