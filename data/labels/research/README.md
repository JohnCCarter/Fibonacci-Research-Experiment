...
| Fil | Schema |
|-----|--------|
| *(legacy Bitfinex/BTC-USD behavior file removed in cleanup)* | [BEHAVIOR_FACIT.md](../../docs/BEHAVIOR_FACIT.md) |
...
**Scope (2026-05-31, [#12](https://github.com/JohnCCarter/Fibonacci-Research-Experiment/issues/12)):** PrimÃ¤r hypotes **A** = maskin fÃ¶reslÃ¥r events, mÃ¤nniska **spot-checkar** â€” inte mass-manuell labeling. Start: [docs/RESEARCH_HANDOFF.md](../../docs/RESEARCH_HANDOFF.md).
